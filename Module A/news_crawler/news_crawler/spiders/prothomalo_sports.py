...
class ProthomAloSportsSpider(scrapy.Spider):
    name = "prothomalo_sports"
    ...
    API_BASE = "https://www.prothomalo.com/api/v1/collections/sports-all"
    ...
    def parse(self, response):
        self.logger.info("Parsing Sports section page")
    ...
    def next_api_request(self):
        ...
        return scrapy.Request(
            ...
            headers={
                ...
                "Referer": "https://www.prothomalo.com/sports"
            }
        )
    ...
    def parse_api(self, response):
        ...
        if not items:
            self.logger.info("No more Sports API items")
            return
