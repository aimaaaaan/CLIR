...
class ProthomAloLatestSpider(scrapy.Spider):
    name = "prothomalo_latest"
    ...
    API_BASE = "https://www.prothomalo.com/api/v1/collections/latest-all"

    offset = 0
    limit = 10
    max_items = 300   # safety cap
    ...
    def parse(self, response):
        self.logger.info("Parsing initial latest page")

        # 1️⃣ HEADLINE-ONLY (NO LINK)
    ...
    def parse_api(self, response):
        ...
        if not items:
            self.logger.info("No more API items")
            return
