...
class ProthomAloPoliticsSpider(scrapy.Spider):
    name = "prothomalo_politics"
    ...
    API_BASE = "https://www.prothomalo.com/api/v1/collections/politics"
    ...
    def parse(self, response):
        self.logger.info("Parsing Politics section page")
    ...
    def next_api_request(self):
        ...
        return scrapy.Request(
            ...
            headers={
                ...
                "Referer": "https://www.prothomalo.com/politics"
            }
        )
    ...
    def parse_api(self, response):
        ...
        if not items:
            self.logger.info("No more Politics API items")
            return
