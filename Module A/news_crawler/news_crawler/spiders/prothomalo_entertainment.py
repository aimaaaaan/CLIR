...
class ProthomAloEntertainmentSpider(scrapy.Spider):
    name = "prothomalo_entertainment"
    ...
    API_BASE = "https://www.prothomalo.com/api/v1/collections/entertainment-all"
    ...
    def parse(self, response):
        self.logger.info("Parsing Entertainment section page")
    ...
    def next_api_request(self):
        ...
        return scrapy.Request(
            ...
            headers={
                ...
                "Referer": "https://www.prothomalo.com/entertainment"
            }
        )
    ...
    def parse_api(self, response):
        ...
        if not items:
            self.logger.info("No more Entertainment API items")
            return
