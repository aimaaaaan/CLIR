...
class ProthomAloBusinessSpider(scrapy.Spider):
    name = "prothomalo_business"
    ...
    API_BASE = "https://www.prothomalo.com/api/v1/collections/business-all"
    ...
    def parse(self, response):
        self.logger.info("Parsing Business section page")

        # 1️⃣ HEADLINE-ONLY ITEMS (NO LINK, WITH POSSIBLE SUB-TITLE)
        for node in response.css("span.tilte-no-link-parent"):
    ...
    def next_api_request(self):
        ...
        return scrapy.Request(
            ...
            headers={
                ...
                "Referer": "https://www.prothomalo.com/business"
            }
        )
    ...
    def parse_api(self, response):
        ...
        if not items:
            self.logger.info("No more Business API items")
            return
