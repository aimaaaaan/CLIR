...
class ProthomAloWorldSpider(scrapy.Spider):
    name = "prothomalo_world"
    ...
    API_BASE = "https://www.prothomalo.com/api/v1/collections/world-all"
    ...
    def parse(self, response):
        self.logger.info("Parsing World section page")
    ...
    def next_api_request(self):
        ...
        return scrapy.Request(
            ...
            headers={
                ...
                "Referer": "https://www.prothomalo.com/world"
            }
        )
    ...
    def parse_api(self, response):
        ...
        if not items:
            self.logger.info("No more World API items")
            return
